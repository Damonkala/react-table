...
class Table extends React.Component{
	render(){
	let content = this.props.data.map( thing => {
		return thing
	})
		return (
			<table>
		<TableBody data={content}/>
		<TableHeaders data={this.props.data}/>
...
ReactDOM.render(<Table data={data1}/>, document.getElementById('Table1'))
ReactDOM.render(<Table data={data2}/>, document.getElementById('Table2'))
// ReactDOM.render(<div> {data1.map(data => <TableRow data={data} />), document.getElementById('react'))
